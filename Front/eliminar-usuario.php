            ...
            <div class="col-lg-12 text-center">
                ...
                <form id="formulario" name="formulario" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="formGroupExampleInput">Desea eliminar el registro:</label>
                        <input type="text" class="form-control" name="RPE" value="<?= $row['rpe'] ?>">
                    </div>
                    <input id="boton" onclick="validacion()" class="btn btn-outline-danger" type="button" value="Eliminar"> 
